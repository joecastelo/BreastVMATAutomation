...
{
    internal class LeftBreastGeometryTool : IBreastGeometryTool
    {
        ...
        public LeftBreastGeometryTool(ExternalPlanSetup plan, IEnumerable<Structure> selectedTargets,
        ...
        {
            Isocenter = SelectIsocenter.ChangeIsocenter(Plan, Target, true);
        ...
        private int CalculateBeamBestInner()
        {
            ...
            try
            {
                for (int i = 0; i < 12; i++)
                {
                    ...
                    beam.FitCollimatorToStructure(new FitToStructureMargins(0, 7, 25, 7), Target, true, true, false);
        ...
        private int CalculateBeamBestOuter()
        {
            ...
            try
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    ExternalBeamMachineParameters parameters = GetStaticParameters();
                    var beam = Plan.AddStaticBeam(parameters, new VRect<double>(), 0, initAngle + (i * 5), 0, Isocenter);
                    beam.FitCollimatorToStructure(new FitToStructureMargins(30, 7, 0, 7), Target, true, true, false);
                ...
                return innerAnglesAreas.OrderBy(e => e.Value).First().Key;
            }
            catch (Exception)
            {
